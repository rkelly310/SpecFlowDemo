...
namespace ToDoListDemo.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "ToDoList", "    Select first two items in the ToDoList\r\n    Enter a new item in the ToDoList\r" +
        ...
        [NUnit.Framework.DescriptionAttribute("Add items to the ToDoList")]
        [NUnit.Framework.CategoryAttribute("ToDoList")]
        public virtual void AddItemsToTheToDoList()
        {
            string[] tagsOfScenario = new string[] {
                    "ToDoList"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Add items to the ToDoList", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
